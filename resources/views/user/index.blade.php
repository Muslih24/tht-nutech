    ...
    <div class="main-panel">
        <div class="content-wrapper">
            ...
            <div class="row mb-2">
                ...
                <div class="col-md-3">
                    <a href="/user/add" class="btn btn-danger" style="float: right;">Tambah Data</a>
                </div>
            </div>
        </div>
...
<script>
    ...
    function deleteData(uuid) {
        Swal.fire({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    window.location = '/user/delete/' + uuid;
                }
            })
    }
    ...
    function exportData() {
        var search = $("#search").val();
        var filter = $("#filter").val();
        window.open("/user/export?&search=" + search + "&filter=" + filter + "", "_blank");
    }
</script>
@endsection